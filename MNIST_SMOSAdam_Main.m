...
TrainImgPath = '.\Training Data\MNIST\train-images.idx3-ubyte';
TrainLabPath = '.\Training Data\MNIST\train-labels.idx1-ubyte';
TestImgPath = '.\Training Data\MNIST\t10k-images.idx3-ubyte';
TestLabPath = '.\Training Data\MNIST\t10k-labels.idx1-ubyte';
...
[dlnetL, dlnetF] = Leader_Follower_FCNN(XTrain(:,:,:,1:3000),YTrain(1:3000),height,width,channels,numClasses,classes);
...
save ANN.mat dlnetL lr miniBatchSize num_samples numEpochs 
